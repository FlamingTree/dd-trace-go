...
package httprouter // import "github.com/FlamingTree/dd-trace-go/contrib/julienschmidt/httprouter"

import (
	"net/http"
	"strings"

	"github.com/FlamingTree/dd-trace-go/contrib/internal/httputil"
